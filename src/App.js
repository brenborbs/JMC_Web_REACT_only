    ...
    return (
      <Layout>
        <Switch>
          ...
          <Route
            path="/services/overview_drydockings"
            exact
            component={Overview_DD}
          />
          <Route
            path="/services/overview_preSurveys"
            exact
            component={Overview_PS}
          />
          <Route
            path="/services/overview_paintTechnology"
            exact
            component={Overview_PT}
          />
          <Route
            path="/services/overview_tankSurveys"
            exact
            component={Overview_TS}
          />
          <Route
            path="/services/overview_newBuildings"
            exact
            component={Overview_NB}
          />
          <Route
            path="/services/overview_consulting"
            exact
            component={Overview_CN}
          />
          <Route
            path="/services/overview_in-service"
            exact
            component={Overview_SV}
          />
          <Route
            path="/services/overview_newBuild-PaintSurvey"
            exact
            component={Overview_NBPS}
          />
