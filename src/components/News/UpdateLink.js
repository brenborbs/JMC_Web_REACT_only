  ...
  return (
    ...
    <Helmet>
      ...
      <div className="card flex-md-row mb-4 box-shadow h-md-250">
        ...
        <img className="card-img-top" src={newUpdate.imgOne} alt={newUpdate.title}
        style={{ height: '500px', width: '100%', display: 'block' }}
        />
            
              <h3 className="mb-0">{newUpdate.title}</h3>
              <div className="mb-1 text-muted"><em>{newUpdate.date}</em></div>
...
// Note change div classname='col-md-6' when adding updates soon!