  ...
  return (
    <div className="section_style" >
      ...
      <div className="topic_container" >
        ...
        <p>
        The cost of our service is predictable as it is based on a day rate for the duration of the dry-docking and compared to the cost of many service engineers and technicians, our rate is low. We are on 24/7 for same day rate. Our main objective is to elevate the quality of the entire surface treatment process by foresight and control. This results in many savings for the ship owner and quality evaluation which will be reflected positively on the future operating budget of the vessel.
        </p>
        <p>
