...
const initialState = [
  ...
  },
  {
    ...
    category: 'Surface Treatment',
    summary: 'As faced by many crews in different vessels particularly in tankers, removing corrosion on rounded shapes is very difficult. Understanding the usage of proper equipment to deal with corrosion on pipes will always be very crucial to the company and the crew.',
  ...
  },
  {
    ...
    summary: 'Power tooling to St 3.0 for the remaining erection joints considering that the damages in a particular tank do not exceed maximum 2% when compared to the whole area. New building construction stage is very important when it comes to quality and its impact when the ship finally goes into service.',
  ...
  },
  {
    ...
    summary: 'Even simple surface preparation techniques are needed to achieve a good and efficient treatment result. Teaching and providing the crew how to use proper surface preparation tools is very important as they sail into highly corrosive environments.',
  ...
  },
  {
    ...
    category: 'Tank Surveys',
    summary: 'The tank condition as transition fair to poor coating condition according to IACS Recommendation 87, Guideline For Coating Maintenance and Repairs. Visualising actual corrosion wastage inside the tanks.',
