...
import photo4 from "../Resources/img/wirebrush.png";
...
const initialState = [
  ...
  },
  {
    ...
    category: "Surface Treatment",
    summary:
      "As faced by many crews in different vessels particularly in tankers, removing corrosion on rounded shapes is very difficult. Understanding the usage of proper equipment to deal with corrosion on pipes will always be very crucial to the company and the crew. The corroded areas especially the heavily pitted ones, must be rectified eventually, in order to prevent the pipes from deteriorating.",
    usage:
      "The photo shows a result of an on-going HPFW treatment on the upper deck. As faced by many crews in different vessels particularly in tankers, removing corrosion on rounded shapes is very difficult. While the use of hand tools are common but then again, the result is not as efficient and not expected coming from a good surface preparation standard.",
    prep:
      "To add, hand tools cannot penetrate small areas especially behind the pipe supports, u-clamps and bolts. For these, HPFW is more suitable to remove corrosion on these behind and cornered areas. This again leads to the importance of having a good maintenance schedule for the deck pipes.",
    application:
  ...
  },
  {
    ...
    summary:
      "The tank has almost more than 70% Hard Scale as described according to IACS PR-33 Owners Hull Inspection. The practical approach to avoid heavy corrosion inside the tanks is to have schedules surveys inside the tanks and if possible, carry out corrosion repairs to prevent the corrosion from going to worse",
    usage:
      "The photo shows that the tank has almost more than 70% Hard Scale as described according to IACS PR-33 Owners Hull Inspection and Maintenance Schemes. The tank on the photo is labeled as colored RED under Traffic Light Condition Scoring.",
    prep:
      "This condition may seem to be more common for older vessels however as what we have encountered in our projects, such conditions are even posible in 5 year old ships. Corrosion once neglected will surely destroy the steel plate which may also affect the over-all structural integrity of the vessel. To prevent such conditions from happening, it is very important to mix practical and theoritical knowledge in surface treatment standards during in-service of the ship.",
    application:
    ...
    photo: photo5,
    web: "Image from IACS PR-33 Owners Hull Inspection and Maintenance Schemes"
  },
  {
    id: "6",
    staff: Staff,
    ...
    category: "Tank Surveys",
    summary:
      "The tank condition as transition fair to poor coating condition according to IACS Recommendation 87, Guideline For Coating Maintenance and Repairs. Visualising actual corrosion wastage inside the tanks.",
    usage:
      "The photo shows the tank condition as transition fair to poor coating condition according to IACS Recommendation 87, Guideline For Coating Maintenance and Repairs for Ballast Tanks and Combined Cargo/Ballast Tanks on Oil tankers. The tank on the photo is at very Poor condition.",
    prep:
      "Transition conditions in Tank surveys are a bit trickier since as an inspector, you are judging whether to give the tank a FAIR pass or POOR neglected condition. To add, the owners are also at pressure to get the vessel to sail continously to avoid downtime and perhaps move the next maintenance treatment on the tanks to a later date to earn some additional savings for the meantime.",
    application:
      "With the difficult dillema at hand, the best recourse would be to take the general and overall view of the tanks, then take in the percentages. Comparing both sides, if more tank areas or percentages fall on POOR conditions, then it gets this rating. Otherwise, the opposite FAIR rating is given once the sum on the FAIR areas exceed the latter.",
    photo: photo6,
    web:
      "Image from IACS Recommendation 87, Guideline For Coating Maintenance and Repairs for Ballast Tanks"
  }
];
